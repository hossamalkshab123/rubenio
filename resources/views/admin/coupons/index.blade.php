        ...
        <div>
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="#">المنتهية</a></li>
                </ul>
            </div>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('admin.coupons.create') }}" class="btn filtering-btn d-flex align-items-center">
                <i class="uil uil-plus me-1"></i> إضافة كوبون جديد
            </a>
        </div>
    </div>
